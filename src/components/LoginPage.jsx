...
const CREDS = { username: 'Ardi7HF3', password: 'akuhitam753' };
        ...
        <div className="rounded-2xl p-8"
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="w-full pl-10 pr-4 py-3 rounded-xl text-sm input-neon"
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-11 py-3 rounded-xl text-sm input-neon"
          ...
          >
            {loading ? (
              <>
                <span className="w-4 h-4 border-2 border-current border-t-transparent rounded-full spin-anim" />
                Memverifikasi...
              </>
            ) : (
              <>
